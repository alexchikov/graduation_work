...
with DAG(
    dag_id="moex_process_candles_iceberg",
    ...
    wait_raw = S3KeySensor(
        ...
        bucket_key="raw/moex/candles/secid=*/date={{ ds }}/*",
        wildcard_match=True,
        poke_interval=60,
        timeout=60 * 30,
    )
    ...
    process = SparkSubmitOperator(
        ...
        application="/home/airflow/dags/apps/candles_to_iceberg.py",
        conf={
    ...
    dq = SparkSubmitOperator(
        ...
        application_args=[
            "--table", "processed.moex_fact_security_candles",
            "--warehouse", "{{ var.value.ICEBERG_WAREHOUSE }}",
        ],
    )
